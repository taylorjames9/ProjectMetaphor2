...
struct  ProtectionLevel_t1119637425 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(ProtectionLevel_t1119637425, ___value___1)); }
