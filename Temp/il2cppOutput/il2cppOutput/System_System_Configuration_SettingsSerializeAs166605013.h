...
struct  SettingsSerializeAs_t166605013 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(SettingsSerializeAs_t166605013, ___value___1)); }
