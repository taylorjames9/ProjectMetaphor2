...
struct  SuffixOrigin_t2288602937 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(SuffixOrigin_t2288602937, ___value___1)); }
