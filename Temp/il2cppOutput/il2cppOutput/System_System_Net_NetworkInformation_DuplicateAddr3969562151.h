...
struct  DuplicateAddressDetectionState_t3969562151 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(DuplicateAddressDetectionState_t3969562151, ___value___1)); }
