...
struct  ProtocolFamily_t3611922670 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(ProtocolFamily_t3611922670, ___value___1)); }
