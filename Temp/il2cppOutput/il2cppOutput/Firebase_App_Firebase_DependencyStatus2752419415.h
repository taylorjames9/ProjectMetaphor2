...
struct  DependencyStatus_t2752419415 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(DependencyStatus_t2752419415, ___value___1)); }
